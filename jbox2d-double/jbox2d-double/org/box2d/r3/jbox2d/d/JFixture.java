...
public class JFixture implements Fixture {
	...
	private org.jbox2d.d.dynamics.Fixture gdx_fixture;

	public JFixture(org.jbox2d.d.dynamics.Fixture f) {
		this.gdx_fixture = f;
	}
	...
	public ShapeType getType() {
		final org.jbox2d.d.collision.shapes.ShapeType T = this.gdx_fixture
				.getType();
	...
	public Shape getShape() {
		org.jbox2d.d.collision.shapes.Shape gdx_shape = this.gdx_fixture
				.getShape();
		if (shape == null) {
			newShape(gdx_shape);
		}
